            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border-t-4 border-pink-400">
                ...
                <form action="{{ route('booking-konsultasi.store') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="id_pasien" required
                            ...
                            @foreach($pasienList as $pas)
                                <option value="{{ $pas->id_pasien }}"
                                    {{ old('id_pasien') == $pas->id_pasien ? 'selected' : '' }}>
                                    {{ $pas->user->name }} ({{ $pas->no_hp }})
                                </option>
                            @endforeach
                    ...
                    @else
                        ...
                        @php
                            $currentPasien = \App\Models\Pasien::where(
                                'id_pengguna',
                        ...
                        @if($currentPasien)
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    class="w-full mt-1 bg-gray-50 border-pink-200 rounded-md text-sm text-gray-600">
                            </div>
                        @endif
                    ...
                    <div>
                        ...
                        <select
                            ...
                            @foreach($dokterList as $doc)
                                ...
                                <option
                                    value="{{ $doc->id_dokter }}"
                                    {{ old('id_dokter') == $doc->id_dokter ? 'selected' : '' }}>
                        ...
                        <p class="text-xs text-gray-500 mt-2">
                            Pilih dokter sesuai jadwal praktek yang tersedia.
                        </p>
                    ...
                    <div>
                        ...
                        <textarea
                            name="catatan"
                            rows="3"
                            placeholder="Ingin mencerahkan noda hitam / facial reguler"
                    ...
                    <div class="flex justify-end gap-2 pt-4">
                        ...
                        <a href="{{ route('booking-konsultasi.index') }}"
                            class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-md font-medium text-sm transition">
                            Batal
                        </a>

                        <button
                            type="submit"
                            class="bg-pink-600 hover:bg-pink-700 text-white px-5 py-2 rounded-md font-semibold text-sm transition shadow-sm">
